...
Route::prefix('v1')->namespace('Api')->group(function(){
    ...
    Route::group(['middleware' => ['jwt.auth']], function(){
        ...
        Route::name('photos.')->prefix('photos')->group(function(){
            Route::delete('/{id}', 'RealStatePhotoController@destroy')->name('delete');
            Route::put('/set-thumb/{photoId}/{realStateId}', 'RealStatePhotoController@setThumb')->name('update-thumb');
        });
    });
});
